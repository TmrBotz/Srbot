   ...
   if update_channel:
      try:
         ...
         if user.status == "kicked":
            await message.reply_text("You are Banned. Contact -- @team_zozo_X_bot")
            return 1
         ...
         await message.reply_text("Something Went Wrong. Contact us @team_zozo_X_bot")
         return 1
